			...
			<View className="mx-8 mt-8 flex flex-col bg-[#FFF8F0]">
				...
				<View className="relative w-full h-48 mt-8">
					...
					>
						...
						{dropdownVisible && (
							<View
								className="shadow-md bg-[#FFF8F0] rounded-2xl p-4 items-center w-56"
								style={{
									position: "absolute",
									top: 28,
									right: 0,
							...
							>
								<Pressable
									className="w-full justify-center items-center rounded-xl py-3"
									onPress={async () => {
								...
								>
									<Text className="font-medium">Upload Banner</Text>
								</Pressable>
								<Pressable
								...
								>
									<Text className="font-medium">Upload Profile Picture</Text>
								</Pressable>
								<Pressable
									className="w-full mt-3 justify-center items-center rounded-xl py-3"
									onPress={() => {
